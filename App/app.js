...
//cambiar de estado las variables para mostrar u ocultar formularios
    ...
    //llenar cursos
     $http.get("http://academiafinalati.azurewebsites.net/api/CURSOS")
         .then(function (data) {
     ...
     //LLENAR JORANADA
    $http.get("http://academiafinalati.azurewebsites.net/api/JORNADAS")
        .then(function (data) {
    ...
    //LLENAR HORARIO
    $http.get("http://academiafinalati.azurewebsites.net/api/HORARIOS")
            .then(function (data) {
     ...
     //cargar el control select con valores
            $http.get("http://academiafinalati.azurewebsites.net/api/BIMESTRES")
            .then(function (data) {
    ...
    $http.get("http://academiafinalati.azurewebsites.net/api/CALIFICACIONES/DesplegarNotas")
        .then(function (data) {
    ...
    $http.get("http://academiafinalati.azurewebsites.net/api/MESESANIO")
        .then(function (data) {
...
$scope.InsertarAlumnos=function (cursoid,jonadaid,horarioid) {
    ...
    $http.post("http://academiafinalati.azurewebsites.net/api/ALUMNOS",$scope.Alumno)
        .then(function (data) {
          /*  console.log("enviado");*/
            console.log(data);
        },function (data) {
...
$scope.AlumnosInscritos=function (cursoid,jornadaid,horarioid) {
    $http.get("http://academiafinalati.azurewebsites.net/api/inscritos/curso/"+cursoid+"/jornada/"+jornadaid+"/horario/"+horarioid+"")
        .then(function (data) {
...
$scope.ListaAsignaNotas=function (curosid,horarioid) {
    $http.get("http://academiafinalati.azurewebsites.net/api/AsignaNotas/curso/"+curosid+"/horario/"+horarioid+"")
        .then(function (data) {
...
$scope.InsertarNotas=function (bimestreid,alumnoid,calificacion) {
  $http.get("http://academiafinalati.azurewebsites.net/api/CALIFICACIONES/insertar/bimestre/"+bimestreid+"/alumno/"+alumnoid+"/calificacion/"+calificacion+"")
      .then(function (data) {
...
$scope.BuscarPorCodigoAlum=function (alumnoid) {
    ...
    $http.get("http://academiafinalati.azurewebsites.net/api/ListaInscritosPorID/"+alumnoid+"")
        .then(function (data,) {
...
$scope.InsertaMensaualidad=function (mesid,alumnoid) {
    $http.post("http://academiafinalati.azurewebsites.net/api/MENSUALIDADES",
             {
                 MES_ID: mesid,
                 ALUMNO_ID: alumnoid,
...
$scope.BuscarMensualidades=function (alumnoid) {
  $http.get("http://academiafinalati.azurewebsites.net/api/MENSUALIDADES/meses/"+alumnoid+"")
      .then(function (data) {
...
$scope.RetirarAlumnos=function (alumnoid) {
    $http.get("http://academiafinalati.azurewebsites.net/api/RetirarAlumnos/"+alumnoid+"")
        .then(function (data) {
...
$scope.ListaDeAlumnosRetirados=function () {
  $http.get("http://academiafinalati.azurewebsites.net/api/alumnosretirados")
      .then(function (data) {
...
$scope.ListadoAlumnosPorCurso=function () {
  $http.get("http://academiafinalati.azurewebsites.net/api/AlumnosPorCurso/1")
        .then(function (data) {
    ...
    $http.get("http://academiafinalati.azurewebsites.net/api/AlumnosPorCurso/2")
        .then(function (data) {
